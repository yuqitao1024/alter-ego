---
name: ability-work-methodology
description: Use when the user needs execution methods, goal management, planning, review, prioritization, project routines, or productivity systems.
---
...
```bash
python3 .agents/ability-rag/scripts/search_rag.py "<关键词>" --category work-methodology --limit 5
```
...
Useful terms: 目标管理、OKR/KPI、PDCA、复盘、时间管理、计划拆解.
